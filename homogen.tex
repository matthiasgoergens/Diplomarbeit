...
\todo{Hannos Ideen: Morphismen zwischen Torus (Umlauftag, Verkehrstag)
  ...
  haben wir echte Homogenität. Homegenität.
...
\todo{Stimmt gar nicht.  Di-Mo-Do als Einheit geplant, ausgerollt,
  inhomogene hinzu, dann Rest der Woche, danach alles andere (wie
  Sonderfahrten).  Hannos Erklärung einbauen.}
...
pleasing in the presence of homogeneity.  \todo{Add more about
