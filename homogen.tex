...
\(S\) as the sum of arc lengths \(\delta\) in the path between the
...
% TODO: Mehrwöchige Fahrten!  Zurückgehen auf die ursprüngliche nicht-zyklische Version!
...
if \(\ol{t}\) departs before \{t\} arrives.  Also a different approach
...
\item with \( \delta (r_1, r_2) = \delta(\ol{r}_1, \ol{r}_2) \),
