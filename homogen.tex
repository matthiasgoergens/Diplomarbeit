...
Putting \label{zwingHoch} into the new form poses bigger
...
\todo{Vorher koennten wir n fuer jeden Bogen unabhaeging waehlen.  Jetzt
  muessen wir eine Abhaengigkeit fordern.

  Was ist die Laenge von \(P\) in terms of n in abhaengigkeit der
  zwischenschritte?  Gluecklicherweise koennen wir das statisch
  bestimmen!  Und das hat auch geklappt in \ref{zwingHochFiniteN}}
